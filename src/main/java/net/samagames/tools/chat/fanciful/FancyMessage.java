...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
    ...
    public FancyMessage(final TextualComponent firstPartText) {
        ...
        if (nmsPacketPlayOutChatConstructor == null) {
            try {
                nmsPacketPlayOutChatConstructor = Objects.requireNonNull(Reflection.getNMSClass("PacketPlayOutChat")).getDeclaredConstructor(Reflection.getNMSClass("IChatBaseComponent"));
    ...
    public FancyMessage achievementTooltip(final Achievement which) {
        try {
            Object achievement = Objects.requireNonNull(Reflection.getMethod(Reflection.getOBCClass("CraftStatistic"), "getNMSAchievement", Achievement.class)).invoke(null, which);
            return achievementTooltip((String) Objects.requireNonNull(Reflection.getField(Reflection.getNMSClass("Achievement"), "name")).get(achievement));
    ...
    public FancyMessage statisticTooltip(final Statistic which) {
        ...
        try {
            Object statistic = Objects.requireNonNull(Reflection.getMethod(Reflection.getOBCClass("CraftStatistic"), "getNMSStatistic", Statistic.class)).invoke(null, which);
            return achievementTooltip((String) Objects.requireNonNull(Reflection.getField(Reflection.getNMSClass("Statistic"), "name")).get(statistic));
        } catch (IllegalAccessException e) {
            Bukkit.getLogger().log(Level.WARNING, "Could not access method.", e);
            return this;
        } catch (IllegalArgumentException e) {
    ...
    public FancyMessage statisticTooltip(final Statistic which, Material item) {
        ...
        try {
            Object statistic = Objects.requireNonNull(Reflection.getMethod(Reflection.getOBCClass("CraftStatistic"), "getMaterialStatistic", Statistic.class, Material.class)).invoke(null, which, item);
            return achievementTooltip((String) Objects.requireNonNull(Reflection.getField(Reflection.getNMSClass("Statistic"), "name")).get(statistic));
        } catch (IllegalAccessException e) {
            Bukkit.getLogger().log(Level.WARNING, "Could not access method.", e);
            return this;
    ...
    public FancyMessage statisticTooltip(final Statistic which, EntityType entity) {
        ...
        try {
            Object statistic = Objects.requireNonNull(Reflection.getMethod(Reflection.getOBCClass("CraftStatistic"), "getEntityStatistic", Statistic.class, EntityType.class)).invoke(null, which, entity);
            return achievementTooltip((String) Objects.requireNonNull(Reflection.getField(Reflection.getNMSClass("Statistic"), "name")).get(statistic));
        } catch (IllegalAccessException e) {
            Bukkit.getLogger().log(Level.WARNING, "Could not access method.", e);
            return this;
    ...
    public FancyMessage itemTooltip(final ItemStack itemStack) {
        try {
            Object nmsItem = Objects.requireNonNull(Reflection.getMethod(Reflection.getOBCClass("inventory.CraftItemStack"), "asNMSCopy", ItemStack.class)).invoke(null, itemStack);
            return itemTooltip(Objects.requireNonNull(Reflection.getMethod(Reflection.getNMSClass("ItemStack"), "save", Reflection.getNMSClass("NBTTagCompound"))).invoke(nmsItem, Objects.requireNonNull(Reflection.getNMSClass("NBTTagCompound")).newInstance()).toString());
        } catch (Exception e) {
            e.printStackTrace();
            return this;
        }
	...
	*/
    ...
    private void send(CommandSender sender, String jsonString) {
        ...
        try {
            ...
            Object connection = Objects.requireNonNull(Reflection.getField(Objects.requireNonNull(handle).getClass(), "playerConnection")).get(handle);
            Objects.requireNonNull(Reflection.getMethod(connection.getClass(), "sendPacket", Reflection.getNMSClass("Packet"))).invoke(connection, createChatPacket(jsonString));
        } catch (IllegalArgumentException e) {
            Bukkit.getLogger().log(Level.WARNING, "Argument could not be passed.", e);
        } catch (IllegalAccessException e) {
            Bukkit.getLogger().log(Level.WARNING, "Could not access method.", e);
    ...
    private Object createChatPacket(String json) throws IllegalArgumentException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
        if (nmsChatSerializerGsonInstance == null) {
            ...
            String[] split = Objects.requireNonNull(version).split("_");
